...
$(function(){
	$.ajax({
		url:"${pageContext.request.contextPath}/teacherIndex/findAllCourse.action",
...
function add(){
	...
	var options = {
			url:"${pageContext.request.contextPath}/teacherIndex/addTeacher.action",
			type:"post",
			dataType:"json",
				...
				if(data.status==0){
					 layer.open({
						  ...
						  ,yes: function(index, layero){
							  window.location.href="${pageContext.request.contextPath}/teacherIndex/goAddPage.action";
						  }
