		...
		<form action="" method="post"
		  ...
		  <div class="form-group">
		   ...
		   <div class="form-group">
		    ...
		    <select class="form-control" name="teachername" id="teacher">
		    </select>
		  </div>
...
$(function(){
	$.ajax({
		url:"${pageContext.request.contextPath}/teacherIndex/findNotMajorTeacher.action",
...
function add(){
	...
	var options = {
			url:"${pageContext.request.contextPath}/banjiIndex/addBanji.action",
			type:"post",
			dataType:"json",
				...
				if(data.status==0){
					 layer.open({
						  ...
						  ,yes: function(index, layero){
							  window.location.href="${pageContext.request.contextPath}/banjiIndex/goAddPage.action";
						  }
