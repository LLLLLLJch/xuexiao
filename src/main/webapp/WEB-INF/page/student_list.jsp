...
<body>
	...
	<input type="button" value="批量删除" onclick="deleteAll();" class="btn btn-default"/>
		<table class="table table-bordered">
			...
			<tr>
				<td>
					<input type="checkbox" name="selectedIds" value="${student.ID}">
				</td>
				<td><a href="javascript:showStudent('${student.ID}');">${student.name}</a></td>
				<td>${student.age}</td>
				<td>
				...
				<td><a href="javascript:update('${student.ID}')">修改</a></td>
				<td><a href="javascript:goDeleteStudent('${student.ID}');">删除</a></td>
			</tr>
			</c:forEach>
		</table>
	</form>
